...
object Community {
    val communityArrayList = arrayListOf(
        ...
        CommunityData(
            ...
            "태풍 오기 전의 날씨!",
            "목요일이다..주말언제되냐..ㅠㅠ",
            "https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F48402b52-fa10-4eff-9a48-b37452e2d457%2FR0005664.jpg?table=block&id=dcb323f5-c2d9-4ab5-afbf-e038c52b12b5&spaceId=83c75a39-3aba-4ba4-a792-7aefe4b07895&width=2000&userId=8cbc65cd-a833-4515-8c5f-0836cea60f66&cache=v2",
            3,
            "30분 전"
        ),
        CommunityData(
        ...
        CommunityData("공지사항", "오늘은월요일", "벌써 월요일이다...이게맞냐...주말언제되냐..ㅠㅠ", "", 99,"2시간 전"),
    )
}